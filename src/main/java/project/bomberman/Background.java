...
public class Background {
    ...
    public Background() {
        ...
        //table to help
        tableBackground = new boolean[this.cols][this.rows];
        for(int i= 0; i < cols; i++) {
            tableBackground[i][0] = true;
...
//            rectangle.fill();
    ...
    public boolean getObstaculesPosition(int col, int row) {
        return tableBackground[col][row];
    }
}
